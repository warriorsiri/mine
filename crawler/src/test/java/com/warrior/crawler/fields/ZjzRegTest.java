...
public class ZjzRegTest {
	...
	public static void intConfig() {
		...
		conds.add(new Tuple("年末全市共有1163家规模以上工业企业，实现增加值760.8亿元，尼玛值111亿元，增长9.4%，实现总产值3317.66亿元，增长10.3%。", "760.8"));
		conds.add(new Tuple("规模以上工业增加值276.38（不含军工涉密企业）亿元，尼玛值111亿元，增长8.5%。", "276.38"));
